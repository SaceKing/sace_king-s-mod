...
public class ForgetmenotBlock extends SaceKingsModModElements.ModElement {
	@ObjectHolder("sace_kings_mod:forgetmenot")
	public static final Block block = null;
	public ForgetmenotBlock(SaceKingsModModElements instance) {
		super(instance, 14);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("forgetmenot"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("sace_kings_mod:forgetmenot"), configuredFeature);
		}
	}
	@SubscribeEvent
	...
	public static class BlockCustomFlower extends FlowerBlock {
		public BlockCustomFlower() {
			super(Effects.SATURATION, 0, Block.Properties.create(Material.PLANTS).doesNotBlockMovement().sound(SoundType.PLANT)
					.hardnessAndResistance(0f, 1000f).setLightLevel(s -> 0));
			setRegistryName("forgetmenot");
		}
