...
package net.mcreator.sacekingsmod.block;
...
import net.mcreator.sacekingsmod.gui.GlassmeltingmachineGui;
...
public class EvaporatorBlock extends SaceKingsModModElements.ModElement {
	@ObjectHolder("sace_kings_mod:evaporator")
	public static final Block block = null;
	@ObjectHolder("sace_kings_mod:evaporator")
	public static final TileEntityType<CustomTileEntity> tileEntityType = null;
	public EvaporatorBlock(SaceKingsModModElements instance) {
		super(instance, 21);
	...
	public void initElements() {
		...
		elements.items
				.add(() -> new BlockItem(block, new Item.Properties().group(SacekingsitemItemGroup.tab)).setRegistryName(block.getRegistryName()));
	}
	private static class TileEntityRegisterHandler {
		@SubscribeEvent
		public void registerTileEntity(RegistryEvent.Register<TileEntityType<?>> event) {
			event.getRegistry().register(TileEntityType.Builder.create(CustomTileEntity::new, block).build(null).setRegistryName("evaporator"));
		}
	}
			...
			if (entity instanceof ServerPlayerEntity) {
				NetworkHooks.openGui((ServerPlayerEntity) entity, new INamedContainerProvider() {
					...
					public ITextComponent getDisplayName() {
						return new StringTextComponent("Evaporator");
					}

					@Override
					public Container createMenu(int id, PlayerInventory inventory, PlayerEntity player) {
						return new GlassmeltingmachineGui.GuiContainerMod(id, inventory,
	...
	public static class CustomTileEntity extends LockableLootTileEntity implements ISidedInventory {
		...
		public Container createMenu(int id, PlayerInventory player) {
			return new GlassmeltingmachineGui.GuiContainerMod(id, player, new PacketBuffer(Unpooled.buffer()).writeBlockPos(this.getPos()));
		}
