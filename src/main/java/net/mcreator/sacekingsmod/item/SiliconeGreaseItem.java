...
public class SiliconeGreaseItem extends SaceKingsModModElements.ModElement {
	@ObjectHolder("sace_kings_mod:silicone_grease")
	public static final Item block = null;
	public SiliconeGreaseItem(SaceKingsModModElements instance) {
		super(instance, 30);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("silicone_grease");
		}
