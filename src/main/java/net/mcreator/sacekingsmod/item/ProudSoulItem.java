...
public class ProudSoulItem extends SaceKingsModModElements.ModElement {
	@ObjectHolder("sace_kings_mod:proud_soul")
	public static final Item block = null;
	public ProudSoulItem(SaceKingsModModElements instance) {
		super(instance, 31);
	}
