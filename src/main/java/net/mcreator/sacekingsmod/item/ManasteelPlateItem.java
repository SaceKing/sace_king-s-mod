...
public class ManasteelPlateItem extends SaceKingsModModElements.ModElement {
	@ObjectHolder("sace_kings_mod:manasteel_plate")
	public static final Item block = null;
	public ManasteelPlateItem(SaceKingsModModElements instance) {
		super(instance, 4);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("manasteel_plate");
		}
