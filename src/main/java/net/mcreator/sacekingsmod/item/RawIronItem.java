...
public class RawIronItem extends SaceKingsModModElements.ModElement {
	@ObjectHolder("sace_kings_mod:raw_iron")
	public static final Item block = null;
	public RawIronItem(SaceKingsModModElements instance) {
		super(instance, 1);
	}
