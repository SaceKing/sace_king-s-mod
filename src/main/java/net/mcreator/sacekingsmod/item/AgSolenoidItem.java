...
public class AgSolenoidItem extends SaceKingsModModElements.ModElement {
	@ObjectHolder("sace_kings_mod:ag_solenoid")
	public static final Item block = null;
	public AgSolenoidItem(SaceKingsModModElements instance) {
		super(instance, 3);
	}
