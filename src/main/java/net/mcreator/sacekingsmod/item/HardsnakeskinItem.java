...
public class HardsnakeskinItem extends SaceKingsModModElements.ModElement {
	@ObjectHolder("sace_kings_mod:hardsnakeskin")
	public static final Item block = null;
	public HardsnakeskinItem(SaceKingsModModElements instance) {
		super(instance, 15);
	}
