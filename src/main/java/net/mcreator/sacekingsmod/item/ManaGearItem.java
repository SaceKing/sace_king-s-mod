...
public class ManaGearItem extends SaceKingsModModElements.ModElement {
	@ObjectHolder("sace_kings_mod:mana_gear")
	public static final Item block = null;
	public ManaGearItem(SaceKingsModModElements instance) {
		super(instance, 5);
	}
