...
public class PcbMixtureItem extends SaceKingsModModElements.ModElement {
	@ObjectHolder("sace_kings_mod:pcb_mixture")
	public static final Item block = null;
	public PcbMixtureItem(SaceKingsModModElements instance) {
		super(instance, 9);
	}
