...
public class BasePCBItem extends SaceKingsModModElements.ModElement {
	@ObjectHolder("sace_kings_mod:base_pcb")
	public static final Item block = null;
	public BasePCBItem(SaceKingsModModElements instance) {
		super(instance, 10);
	}
