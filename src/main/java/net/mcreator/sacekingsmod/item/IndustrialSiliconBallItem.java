...
public class IndustrialSiliconBallItem extends SaceKingsModModElements.ModElement {
	@ObjectHolder("sace_kings_mod:industrial_silicon_ball")
	public static final Item block = null;
	public IndustrialSiliconBallItem(SaceKingsModModElements instance) {
		super(instance, 7);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("industrial_silicon_ball");
		}
