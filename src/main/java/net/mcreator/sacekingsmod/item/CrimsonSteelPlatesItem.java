...
public class CrimsonSteelPlatesItem extends SaceKingsModModElements.ModElement {
	@ObjectHolder("sace_kings_mod:crimson_steel_plates")
	public static final Item block = null;
	public CrimsonSteelPlatesItem(SaceKingsModModElements instance) {
		super(instance, 29);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("crimson_steel_plates");
		}
